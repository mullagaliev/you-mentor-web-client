...
import MentorIcon from '../common/icons/Mentor';
import { Button, Icon } from 'semantic-ui-react';

const style = require('./MentorsList.sass');
              ...
              items && items.map((item, key) => {
                return (
                    <div key={item.id} className={style.AdditionalInfoElem}>
                      <MentorIcon className={style.AdditionalInfoElemIcon}
                                  width={'40px'}
                                  height={'40px'}/>
